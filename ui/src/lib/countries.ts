...
const PRIORITY_COUNTRY_CODES = ['GB', 'GB-ENG', 'GB-SCT', 'GB-WLS', 'GB-NIR', 'IE'];

export const PRIORITY_COUNTRIES = ALL_COUNTRIES.filter(c => PRIORITY_COUNTRY_CODES.includes(c.code));
export const OTHER_COUNTRIES = ALL_COUNTRIES.filter(c => !PRIORITY_COUNTRY_CODES.includes(c.code));
